...
def test_from_transaction():
    ...
    testdata_list = [
        {'input': '0xe7f15771a3cfaca86dd109edd801ad83f1ca3e526e59ae5a370433032874d539',
         ...
         'result': LiquidityChange(method_type='add', token0='0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c',
        ...
        {'input': '0x535303462f40ec3254eb4eb51fa6c903a248502dd0c375696ec6773401c613c7',
         ...
         'result': LiquidityChange(method_type='remove', token0='0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c',
